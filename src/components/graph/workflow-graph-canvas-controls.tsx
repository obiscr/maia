    ...
    <div className="flex w-full flex-wrap items-center justify-start gap-2 sm:w-auto sm:justify-end">
      ...
      {props.showLayout || props.showFit ? (
        <ButtonGroup className="shrink-0 rounded-md border bg-background">
          ...
          {props.showFit ? (
            <Button variant="secondary" size="sm" onClick={props.onFit} aria-label={t("common.graphControls.fitViewAriaLabel")}>
      ...
      {props.showZoom ? (
        <ButtonGroup className="shrink-0 rounded-md border bg-background">
          <Button variant="secondary" size="sm" onClick={props.onZoomIn} aria-label={t("common.graphControls.zoomInAriaLabel")}>
            <ZoomIn className="h-4 w-4" />
          </Button>
          <Button variant="secondary" size="sm" onClick={props.onZoomOut} aria-label={t("common.graphControls.zoomOutAriaLabel")}>
