...
const server = http.createServer(async (req, res) => {
  ...
  try {
    ...
    // Do not leak internal error details (or stack traces) to clients.
    // Instead, log server-side with an errorId that clients can report.
    ...
    return json(res, 500, { ok: false, code: "INTERNAL_ERROR", errorId })
  }
